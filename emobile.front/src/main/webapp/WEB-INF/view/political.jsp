			...
			<div class="container">	
				<div class="col-md-6">
					...
					<div class="details col-md-6">
						<h3 class="product-title"><b><i>politically Incorrect</i></b></h3>

						<p class="product-description">Adult Party Game Where Players Strive to find the Most Appropriately Inappropriate Answer
Game Design Makes Sure Personally Incorrect Stays Funny After Repeated Plays. </p>
